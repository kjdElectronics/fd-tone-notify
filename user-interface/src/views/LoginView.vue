  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <div class="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
        <h3 class="text-sm font-medium text-blue-800 mb-2">🔒 Security Notice</h3>
        <ul class="text-xs text-blue-700 space-y-1">
          <li>• This interface provides full system configuration access</li>
          <li>• Only authorized personnel should use this interface.</li>
          <li>• This services should only be accessible via localhost</li>
        </ul>
      </div>
